        ...
        <!-- Nav Item - Dashboard -->
            <li class="nav-item active"style="">
                <a class="nav-link" href="<?=site_url('admin')?>">
                    ...
                    <span style="font-family: 'cambria', sans-serif;">Dashboard Admin</span></a>
            </li>
              <!-- Divider -->
              <hr class="sidebar-divider my-0">
        <!-- Heading -->
         ...
         <li class="nav-item"style="">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <a class="collapse-item" href="<?=site_url('admin/user')?>">Data Pengguna</a>
                        <a class="collapse-item" href="<?=site_url('admin/buku')?>">Data Buku</a>
                        <a class="collapse-item" href="<?=site_url('admin/kategori')?>">Kategori</a>
                        <a class="collapse-item" href="<?=site_url('admin/ulasan')?>">Ulasan</a>
            ...
            <li class="nav-item"style="">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span style="font-family: 'cambria', sans-serif;">Transaksi</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"></h6>
                        <a class="collapse-item" href="<?=site_url('admin/read_peminjaman')?>">Histori Peminjaman</a>
                    </div>
                </div>
            </li>
            <li class="nav-item active">
            <li class="nav-item">
                <a class="nav-link" href="<?=site_url('admin/laporanpeminjaman')?>">
                    <i class=""></i>
